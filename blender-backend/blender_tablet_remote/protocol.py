...
_TOOL_PARAMETERS = {
    ...
    "KNIFE": [
        ...
        {"id": "snap_mode", "label": "Destino", "type": "enum", "default": "AUTO",
         "values": ["AUTO", "VERTEX", "EDGE_CENTER", "EDGE"]},
    ],
    "BISECT": [
...
FEATURES = {
    ...
    "parametric_transforms": {
        ...
        "move_snap": ["NONE", "INCREMENT", "VERTEX", "EDGE", "EDGE_CENTER", "FACE", "FACE_CENTER"],
        "reference": {"command": "transform.reference_candidate", "auto": True,
                      "types": ["VERTEX", "EDGE_CENTER", "EDGE", "FACE"],
    ...
    "edit_tools": {"version": 9,
                   ...
                   "knife": {"snap": True, "close": True, "pop": True, "cut_through": False,
                             "threshold": 0.080, "edge_threshold": 0.042,
                             "edge_center_threshold": 0.070, "snap_priority": ["VERTEX", "EDGE_CENTER", "EDGE"],
                             "auto_vertex_threshold": 0.035,
                             "auto_edge_center_threshold": 0.028,
                             "snap_modes": ["AUTO", "VERTEX", "EDGE_CENTER", "EDGE"],
                             "deferred_commit": True, "staged_preview": True,
                             "drag": True, "point_on_release": True,
                             "multiple_strokes": True, "new_stroke": True,
                             "projection": True,
